...
git remote set-url origin https://github.com/Sakib-Rahman-Bangladesh/bubble-shooter
############
# Step: 07 #
############
...
git push --all -f https://github.com/Sakib-Rahman-Bangladesh/bubble-shooter
